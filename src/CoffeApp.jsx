      ...
      <div className="bg-[#1B1D1F] p-10">
        <div className="text-center">
          ...
          <div className="m-5 flex space-x-4 items-center justify-center">
            ...
            <Button buttonActive={'a'} textButton={"All Products"} className={'bg-[#6F757C] p-1.5 rounded-lg text-[#FEF7EE]'}/>
            <Button buttonActive={state} textButton={"Available Now"} className={'text-[#FEF7EE]'}/>
          </div>
        </div>
        <Cards />
      </div>
